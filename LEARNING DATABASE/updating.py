...
for row in cur.fetchall():
    print(f"UniqueId:{row[0]} Name:{row[1]} Surname: {row[2]}")  # prints first_name, last_name, email



cur.execute(" UPDATE customers SET last_name='Sahu' WHERE first_name='suraksha'")
